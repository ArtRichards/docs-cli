...
staying `Lifecycle: active` until M29 publishes the train. **M29** is next and
remains a registered draft stub; it is scoped when it starts, and with M28a
landed the train has no unmerged implementation milestone left.
