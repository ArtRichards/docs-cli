...
classified RED baseline is **884 collected, 104 failed, 780 passed** with 769
of the 777 pre-existing ids mechanically proven still GREEN, after a
same-instance audit and an independent fresh-eyes review whose blocker and six
should-fixes are folded in. Phase 5 opens
