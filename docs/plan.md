...
| M14 — Robustness + autonomous archive (v1.6.0) | **Draft** (2026-05-29; re-scoped 2026-06-02 — authoring set split to M15; keeps `docs mv` atomicity, `docs new` strict-root, `docs touch` excludes, slug/`OSError` guards, non-interactive `archive --cascade`, bundled-ref + packaging fixes; builds 1.6.0 locally) | [m14-robustness-agent-native.md](m14-robustness-agent-native.md) | [Log](m14-robustness-agent-native-impl.md) |
| M15 — Agent-native doc authoring (v1.6.0) | **Draft** (2026-06-02; carved from M14 — `docs project set`, single-file `docs stamp`, `--body-from` real-frontmatter detector, skill/cli docs; depends on M14; builds 1.6.0 locally, publish is M17) | [m15-agent-native-authoring.md](m15-agent-native-authoring.md) | [Log](m15-agent-native-authoring-impl.md) |
