...
(contract + RED baseline) are complete (2026-08-11) and Phases 5–7
(interfaces, core, CLI/docs/skill surface) are complete on
`m25/phases-5-10` (2026-08-12); M26–M29 are registered draft stubs. Execution order is expressed by reciprocal
