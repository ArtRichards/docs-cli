...
- parent-of: archive/2026-08-16/m25-reciprocal-relationship-integrity.md
- parent-of: archive/2026-08-16/m26-safe-archive-selection.md
- parent-of: archive/2026-08-16/m27-markdown-body-link-validation.md
- parent-of: archive/2026-08-16/m28-move-safe-body-link-rewrites.md
- parent-of: archive/2026-08-16/m28a-archive-date-witness.md
- parent-of: archive/2026-08-16/m29-pypi-publish-2-0-0.md
...
publishes the train. **M28a is complete and merged to `main` too
(2026-08-16, `91cc839`) — milestone setup
...
`m28a/phases-5-10` (2026-08-16), taking the suite fully GREEN — 1504 passed
after a fifteen-issue same-instance audit and a no-blocker fresh-eyes review
that killed 19 of 19 mutations and returned four should-fixes plus six binding
nits, all folded in. Setup's
...
2026-08-16) and is **merged to `main`** (2026-08-16, `91cc839`, 1504 GREEN),
staying `Lifecycle: active` until M29 published the train. **M29 — PyPI publish
2.0.0 was activated and shipped the same day** (2026-08-16): its stub was
expanded into a five-phase runbook plan, its implementation log opened, its
three activation questions resolved as **D1–D4**, and all five phases run in
one session. **`docs-cli==2.0.0` is live on PyPI** with chain of custody
bit-perfect for wheel and sdist, `v2.0.0` annotated at `408ef6c`, `main` pushed
`f855b80..408ef6c` (101 commits), and the nine headline contracts passing 9/9
against the local, TestPyPI-served and PyPI-served wheels alike. Setup's
readiness pass earned its keep: its one blocker — `twine 6.2.0` unable to check
the `Metadata-Version: 2.5` artifacts this tree now builds — was cleared by D1
at Phase 2 rather than discovered mid-upload. **The v2.0 train is complete and
archived.**
