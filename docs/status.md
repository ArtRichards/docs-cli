...
**M28 — Move-safe Markdown body-link rewrites is the current milestone, and
...
on `m28/phases-5-10` (2026-08-15): the suite is fully GREEN at **1338 passed**,
...
Phase 10. M28 stays `Lifecycle: active` until the M29 publish closeout;
**M28a** and **M29** are next. Milestone setup completed 2026-08-15 with all
