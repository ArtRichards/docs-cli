...
**M28a — Structured archive-date witness is the current milestone. Milestone
setup is complete (2026-08-15) with **all seven setup questions RESOLVED**;
Phase 1 — Define Contract is next and does not re-open them.** No TDD phase has
started. M28a ships **two legs**. **Detect:** `docs archive` writes an
...
the M29 publish closeout; **M28a** and **M29** are next. Milestone setup completed 2026-08-15 with all
...
- **M28a — Structured archive-date witness (IN FLIGHT, setup complete
  2026-08-15, all seven setup questions RESOLVED):** depends on M26; **two
...
**Next action:** **begin M28a Phase 1 — Define Contract**, then
...
and Q2/Q3/Q5/Q6/Q7 conductor-resolved; no TDD phase has started. **M28 is complete and merged to `main`**
