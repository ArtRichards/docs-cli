...
Phase 5 is complete (2026-08-14).** M27 adds a pure, stdlib-only, linear scanner over a
...
- **M27 — Markdown body-link validation (IN FLIGHT, Phases 1–5 done
...
**Next action:** **continue M27 Step 2 — Phase 6, Implement Offline/Core Path
plus the D6 live-tree repair, in one commit.**
...
`m27/phases-5-10` — Phase 5 is complete** (2026-08-14). Phase 1 froze the
...
them changes what the scanner hands M28. Each phase is recorded in the
