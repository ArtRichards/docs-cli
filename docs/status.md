...
**M26 — Safe explicit archive selection is the current milestone.
Phases 1–3 are complete (2026-08-12 / 2026-08-13, `m26/phases-1-4`);
Phase 4 — Run Tests (RED Baseline) is next.** M26 decouples relationship context from archive
...
- **M26 — Safe explicit archive selection (IN FLIGHT, Phases 1–3 complete
  2026-08-13, all seven setup questions RESOLVED):** unscoped
...
**Next action:** **continue M26 Step 1 with Phase 4 — Run Tests (RED Baseline).**
...
retired flag; **867 collected**. Phase 4 captures the classified RED baseline
and proves mechanically that no pre-existing test regressed. Each phase is
recorded in the [M26 log](m26-safe-archive-selection-impl.md). M25 is
