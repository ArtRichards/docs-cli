...
**M28a — Structured archive-date witness is the current milestone. Phases 1–2
are complete on `m28a/phases-1-4` (contract 2026-08-15, RED tests 2026-08-16);
Phase 3 — Create Data/Fixtures is next.** All seven setup questions were RESOLVED before Phase 1,
...
to widen the `docs mv` predicate). No product code changed and the suite is
unchanged at **1341 passed**. M28a ships **two legs**. **Detect:** `docs archive` writes an
...
- **M28a — Structured archive-date witness (IN FLIGHT, Phases 1–2 complete
  on `m28a/phases-1-4`; all seven setup questions RESOLVED, the contract
  frozen, and 131 RED-baseline test ids authored against it):** depends on M26; **two
...
**Next action:** **M28a Phase 3 — Create Data/Fixtures**, then
...
changed and the suite was unchanged at **1341 passed**. **Phase 2 — Write Tests
(RED) completed 2026-08-16**: **131** authored ids across ten test files, 1472
collected, **68 RED / 63 GREEN** at baseline, and **0** pre-existing ids
failing. **M28 is complete and merged to `main`**
