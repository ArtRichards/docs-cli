...
**M28a — Structured archive-date witness is the current milestone. Phase 1 —
Define Contract is complete (2026-08-15) on `m28a/phases-1-4`; Phase 2 — Write
Tests (RED) is next.** All seven setup questions were RESOLVED before Phase 1,
...
- **M28a — Structured archive-date witness (IN FLIGHT, Phase 1 complete
  2026-08-15 on `m28a/phases-1-4`; all seven setup questions RESOLVED and the
  contract frozen):** depends on M26; **two
...
**Next action:** **M28a Phase 2 — Write Tests (RED)**, then
...
changed and the suite is unchanged at **1341 passed**. **M28 is complete and merged to `main`**
