...
that contract and captured the classified baseline — 1489 collected, **60 RED
...
- **M28a — Structured archive-date witness (IN FLIGHT, Step 1 — Phases 1–4 —
  ...
  contract frozen, and 136 classified RED-baseline test ids plus six fixture
...
**136** authored ids across twelve test files and **six** `archivedate-*`
fixture trees; 1489 collected, **60 RED / 88 GREEN** of the 148 new ids in
exactly two exception classes (26 `AttributeError` at the pure seam, 34
`AssertionError`), **0** collection errors / xfails / tracebacks, **0** ids
removed and **0** pre-existing ids failing against `7f7853b`, every pre-M28a
fixture tree byte-identical, and `cli.py` untouched. The **same-instance
audit** then found and fixed eight issues — the largest being that both message
catalogues under-constrained their raw-string requirement, and that `cli.md`'s
promise that five verbs never write the witness was locked for only three —
adding five locks and escalating nothing. **M28 is complete and merged to `main`**
