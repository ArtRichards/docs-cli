...
**M27 — Markdown body-link validation is the current milestone. Step 1 is
complete on `m27/phases-1-4`; Step 2 is in flight on `m27/phases-5-10` —
Phases 5–9 are complete (2026-08-14), the live tree is repaired,
`docs check` is clean with both rules in force, and the suite is fully GREEN
at 1079 passed / 0 failed.** M27 adds a pure, stdlib-only, linear scanner over a
...
- **M27 — Markdown body-link validation (IN FLIGHT, Phases 1–9 done
...
**Next action:** **continue M27 Step 2 — Phase 10, Quality / Docs /
Refactor.**
M27's milestone setup completed 2026-08-14 on
`m27/milestone-setup` with **all seven setup questions resolved**;
**Step 1 is complete — Phases 1–4**, and **Step 2 is in flight on
`m27/phases-5-10` — Phases 5–9 are complete** (2026-08-14). Phase 1 froze the
...
lock**. The real tree was never written to. Each phase is recorded in the
