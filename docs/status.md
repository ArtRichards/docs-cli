...
that contract and captured the classified baseline — 1484 collected, **58 RED
and 85 GREEN** of the 143 new ids, in exactly two exception classes, with
...
- **M28a — Structured archive-date witness (IN FLIGHT, Step 1 — Phases 1–4 —
  ...
  contract frozen, and 131 classified RED-baseline test ids plus six fixture
...
trees; 1484 collected, **58 RED / 85 GREEN** of the 143 new ids in exactly two
exception classes (25 `AttributeError` at the pure seam, 33 `AssertionError`),
**0** collection errors / xfails / tracebacks, **0** ids removed and **0**
pre-existing ids failing against `7f7853b`, every pre-M28a fixture tree
byte-identical, and `cli.py` untouched. **M28 is complete and merged to `main`**
