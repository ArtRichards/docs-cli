...
**Current phase:** Phase 5 — Update Base Interfaces (next). Phases 1–4 complete (contract, tests, fixtures, RED baseline); implementation paused after Phase 4 by request.
...
| M2 — Mutating verbs (`new`, `archive`, `mv`, `touch`) | **ACTIVE** (Phases 1–4 done) | [Plan](m2-mutating-verbs.md) | [Log](m2-mutating-verbs-log.md) |
