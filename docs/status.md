...
Phases 5 and 6 are complete (2026-08-14), the live tree is repaired, and
`docs check` is clean with both rules in force.** M27 adds a pure, stdlib-only, linear scanner over a
...
- **M27 — Markdown body-link validation (IN FLIGHT, Phases 1–6 done
...
**Next action:** **continue M27 Step 2 — Phase 7, Update Tool/Wrapper
Layer.**
...
`m27/phases-5-10` — Phases 5 and 6 are complete** (2026-08-14). Phase 1 froze the
...
REDs left being Phase 7's two surface locks. Each phase is recorded in the
