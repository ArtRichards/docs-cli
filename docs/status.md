...
`cli.md`, the RED tests are written (598 collected; 47 RED / 9 GREEN-at-baseline
locks; the prior 543 stay GREEN), and **Phase 5 (Update Base Interfaces) is
next.** **Re-scoped to CLI-only 2026-06-29**
...
`cli.md`, the RED tests are written (598 collected; 47 RED / 9
GREEN-at-baseline locks; the prior 543 stay GREEN). OPEN QUESTIONS are netted
