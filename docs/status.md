...
Phases 5, 6 and 7 are complete (2026-08-14), the live tree is repaired,
`docs check` is clean with both rules in force, and the suite is fully GREEN
at 1079 passed.** M27 adds a pure, stdlib-only, linear scanner over a
...
- **M27 — Markdown body-link validation (IN FLIGHT, Phases 1–7 done
...
**Next action:** **continue M27 Step 2 — Phase 8, Run Tests (GREEN).**
...
`m27/phases-5-10` — Phases 5, 6 and 7 are complete** (2026-08-14). Phase 1 froze the
...
early — Phase 8 is a log-and-prove gate. Each phase is recorded in the
